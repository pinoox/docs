# شرح تطبيقي: تطبيق ويب لدفتر الهاتف

[← العودة إلى الفهرس](../README.md)

ابنِ **تطبيق ويب** بسيطًا باستخدام Twig: قائمة جهات اتصال، نموذج إضافة، وحذف الإدخالات. تُخزَّن البيانات في MySQL.

**الحزمة (Package):** `com_acme_phonebook`  
**الرابط (URL):** `http://localhost/pinoox/phonebook`  
**الكود المصدري الكامل:** [docs/source/phonebook-app/](../../source/phonebook-app/) — انسخه إلى `apps/`
---

## المتطلبات المسبقة

- Pinoox مثبَّت
- أساسيات [الموجّهات (routers)](../basic/routers.md) و[العروض (views)](../basic/views.md)
...
## الخطوة 4 — الإجراءات المسماة (Named Actions)
...
> **لماذا ملفّا مسارات؟** في `actions.php` تُعرّف المعالج (handler) **مرة واحدة**. وفي `web.php` تربط فقط الرابط + طريقة HTTP بذلك الإجراء (`@contact.list`). يمكنك تغيير الرابط دون لمس ربط الـ Controller.

---

## الخطوة 5 — مسارات الويب
...
الملف `theme/default/pages/list.twig`:
...
## الخطوة 8 — افتحه في المتصفح

```
http://localhost/pinoox/phonebook
```

أضف بعض جهات الاتصال وجرّب الحذف.

---

## الخطوة 9 — أفكار للتوسعة

| الترقية | التوثيق ذو الصلة |
|---------|-------------|
| تعديل جهة اتصال | [المتحكمات (Controllers)](../basic/controllers.md) |
| البحث | [منشئ الاستعلامات (Query Builder)](../database/query-builder.md) |
| تسجيل الدخول | [Flows / المصادقة (Auth)](../basic/flows.md) |
