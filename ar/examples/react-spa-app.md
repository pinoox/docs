# شرح تطبيقي: لوحة React SPA

[← العودة إلى الفهرس](../README.md)

**لوحة مهام React 18** (Todo) — API في PHP، وواجهة المستخدم في React مع Vite. نقطة دخول React الافتراضية في Pinoox: `src/main.jsx`.

**الحزمة (Package):** `com_acme_react_tasks`  
**الرابط (URL):** `http://localhost/pinoox/react-tasks`  
**الملف الشخصي (Profile):** `spa` · **المكدس (stack):** `react`  
**الكود المصدري الكامل:** [docs/source/react-spa-app/](../../source/react-spa-app/) — انسخه إلى `apps/`
---

## المتطلبات المسبقة

- Node.js 18+ و npm
- [الطلبات (Requests)](../basic/requests.md) و [الاستجابات (Responses)](../basic/responses.md) لواجهات JSON API
...
2. افتح SPA؛ أضف المهام، أكمِلها، واحذفها.
...
| الموضوع | React | Vue |
|---------|-------|-----|
| نقطة الدخول | `src/main.jsx` | `src/main.js` |
| Scaffold | `--stack=react` | `--stack=vue` |
| Bootstrap | `getUrl()` في `boot.js` | نفس الشيء |

---

## توثيقات ذات صلة

- [شرح Vue SPA](./vue-spa-app.md)
- [لوحة المهام (Twig)](./task-board-app.md)
