# شرح تطبيقي: تطبيق مدونة بسيط

[← العودة إلى الفهرس](../README.md)

ابنِ مدونة صغيرة: **قائمة المنشورات**، **صفحة منشور واحد** مع slug في الرابط، ونموذج **كتابة منشور**. مثال جيد لتعلّم المسارات الديناميكية وصفحات Twig متعددة.

**الحزمة (Package):** `com_acme_blog`  
**الرابط (URL):** `http://localhost/pinoox/blog`  
**الكود المصدري الكامل:** [docs/source/blog-app/](../../source/blog-app/) — انسخه إلى `apps/`
---

## المتطلبات المسبقة

- [الموجّهات (Routers)](../basic/routers.md) — معامل `{slug}`
...
> **مسار ديناميكي:** يُمرَّر `{slug}` إلى المتحكم كـ `$slug`.
...
1. `/blog/write` — أنشئ منشورًا.
2. بعد الإرسال ستصل إلى `/blog/post/your-slug`.
3. `/blog` يعرض القائمة.
...
| الترقية | التوثيق |
|---------|-----|
| قائمة مع ترقيم صفحات | [Pagination](../database/pagination.md) |
| حماية `/write` | [Flows / Auth](../basic/flows.md) |
...
- [القوالب (Twig)](../basic/templates.md)
