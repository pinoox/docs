...
O Pinoox 3.x não inclui **Model Factory** (estilo Laravel) na CLI. A abordagem recomendada para dados iniciais e de desenvolvimento são **Seeders** com `SeederBase` em `apps/{package}/database/seed/`.
