# Passo a passo: Quadro de tarefas (Todo)

[← Voltar ao índice](../README.md)

Um **quadro de tarefas diárias**: adicione tarefas, marque-as como concluídas e **filtre** com uma query string (`?status=pending`). Prático para painéis internos e para aprender filtragem por query em controllers.

**Pacote:** `com_acme_tasks`  
**URL:** `http://localhost/pinoox/tasks`  
**Código-fonte completo:** [docs/source/task-board-app/](../../source/task-board-app/) — copie para `apps/`
---

## Pré-requisitos

- [Requests](../basic/requests.md) — parâmetros de query
- [Banco de dados / Eloquent](../database/getting-started.md)
...
> **Query string:** `$request->get('status')` lê `?status=pending` — sem necessidade de uma rota extra.

---

## Passo 6 — Template Twig (CSS inline)
...
1. Adicione várias tarefas.
2. Marque algumas como concluídas com ✓.
3. O filtro “Open” mostra apenas as `pending`.
4. Use ↩ para reabrir.
...
|---------|-----|
| Prioridade / data de entrega | [Mutators e casts](../eloquent-orm/mutators-casts.md) |
| API mobile | [Passo a passo da API de notas](./simple-api-app.md) |
| Login de usuário | [Gerenciamento de usuários](../advanced/user-management.md) |
...
- [Scopes do Eloquent](../eloquent-orm/getting-started.md)
