# Tutorial: painel SPA React

[← Voltar ao índice](../README.md)

Um **painel de tarefas React 18** (Todo) — API em PHP, UI em React com Vite. Entrada React padrão do Pinoox: `src/main.jsx`.

**Pacote:** `com_acme_react_tasks`  
**URL:** `http://localhost/pinoox/react-tasks`  
**Perfil:** `spa` · **stack:** `react`  
**Código completo:** [docs/source/react-spa-app/](../../source/react-spa-app/) — copie para `apps/`
---

## Pré-requisitos

- Node.js 18+ e npm
- [Requests](../basic/requests.md) e [Responses](../basic/responses.md) para APIs JSON
...
2. Abra a SPA; adicione, conclua e exclua tarefas.
...
| Tópico | React | Vue |
|-------|-------|-----|
| Entrada | `src/main.jsx` | `src/main.js` |
| Scaffold | `--stack=react` | `--stack=vue` |
| Bootstrap | `getUrl()` em `boot.js` | Igual |

---

## Documentação relacionada

- [Vue SPA walkthrough](./vue-spa-app.md)
- [Task board (Twig)](./task-board-app.md)
