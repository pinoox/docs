...
**Full source:** [docs/source/gallery-app/](../../source/gallery-app/) — copy to `apps/`
---
...
## Step 2 — app.php settings

Enable transport and filesystem for uploads:
...
Do not forget **`enctype="multipart/form-data"`** on the upload form.
