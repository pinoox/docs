...
**Full source:** [docs/source/contact-form-app/](../../source/contact-form-app/) — copy to `apps/`
---
...
> Later you can notify an admin with [Event + mail](../advanced/mail.md) on `create` — keep sending logic in a Component.
...
1. Open `http://localhost/pinoox/contact`.
2. Submit with an invalid email — validation error.
3. Valid form — redirects to `/contact/thanks`.
4. Check table `com_acme_contact_messages` in phpMyAdmin.
...
| Email notification | [Mail](../advanced/mail.md) |
| Admin inbox | [Flows + Auth](../basic/flows.md) |
