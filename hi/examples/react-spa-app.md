# वॉकथ्रू: React SPA पैनल

[← इंडेक्स पर वापस जाएँ](../README.md)

एक **React 18 टास्क पैनल** (Todo) — API PHP में, UI React + Vite में। Pinoox का डिफ़ॉल्ट React entry: `src/main.jsx`।

**पैकेज:** `com_acme_react_tasks`  
**URL:** `http://localhost/pinoox/react-tasks`  
**प्रोफ़ाइल:** `spa` · **स्टैक:** `react`  
**पूरा सोर्स:** [docs/source/react-spa-app/](../../source/react-spa-app/) — `apps/` में कॉपी करें
---

## पूर्व-आवश्यकताएँ (Prerequisites)

- Node.js 18+ और npm
- JSON API के लिए [Requests](../basic/requests.md) और [Responses](../basic/responses.md)
...
2. SPA खोलें; टास्क जोड़ें, पूर्ण करें और डिलीट करें।
...
| Bootstrap | `boot.js` में `getUrl()` | समान |

---

## संबंधित दस्तावेज़

- [Vue SPA वॉकथ्रू](./vue-spa-app.md)
- [टास्क बोर्ड (Twig)](./task-board-app.md)
