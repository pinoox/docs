...
small blog 구축: **post list**, URL slug가 있는 **single post page**, **write post** form. dynamic route와 여러 Twig page 학습에 좋음.

**Package:** `com_acme_blog`  
**URL:** `http://localhost/pinoox/blog`  
**Full source:** [docs/source/blog-app/](../../source/blog-app/) — `apps/`에 copy
---
...
> **Dynamic route:** `{slug}`는 Controller의 `$slug`로 전달됩니다.
