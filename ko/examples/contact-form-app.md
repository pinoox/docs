...
연락처 양식은 비즈니스 웹사이트에서 가장 흔한 구성 요소 중 하나입니다. 이 실습 가이드에서는 입력을 **검증**하고, **메시지를 데이터베이스에 저장**한 뒤 감사 페이지로 리디렉션합니다.

**Package:** `com_acme_contact`  
**URL:** `http://localhost/pinoox/contact`  
**Full source:** [docs/source/contact-form-app/](../../source/contact-form-app/) — `apps/`에 copy
---
