...
**React 18 task panel**(Todo) — PHP API, Vite React UI. Pinoox React default entry: `src/main.jsx`.

**Package:** `com_acme_react_tasks`  
**URL:** `http://localhost/pinoox/react-tasks`  
**Profile:** `spa` · **stack:** `react`  
**Full source:** [docs/source/react-spa-app/](../../source/react-spa-app/) — `apps/`에 copy
---
...
2. Open the SPA; add, complete, and delete tasks.
...
| Bootstrap | `getUrl()` in `boot.js` | Same |

---

## 관련 문서

- [Vue SPA 실습 가이드](./vue-spa-app.md)
