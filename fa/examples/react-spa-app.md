...
**پکیج:** `com_acme_react_tasks`  
**آدرس:** `http://localhost/pinoox/react-tasks`  
**پروفایل:** `spa` · **stack:** `react`  
**سورس کامل:** [docs/source/react-spa-app/](../../source/react-spa-app/) — کپی در `apps/`
---

## پیش‌نیاز

- Node.js 18+ و npm
- [Request](../basic/requests.md) و [Responses](../basic/responses.md) برای API JSON
...
2. SPA را باز کنید؛ کار اضافه، انجام‌شده و حذف کنید.
...
| bootstrap | `getUrl()` در `boot.js` | همان |

---

## مستندات مرتبط

- [نمونه Vue SPA](./vue-spa-app.md)
- [تابلوی کار (Twig)](./task-board-app.md)
