# Пошаговое руководство: веб-приложение «Телефонная книга»

[← Назад к оглавлению](../README.md)

Создадим простое **веб-приложение** на Twig: список контактов, форма добавления и удаление записей. Данные хранятся в MySQL.

**Пакет:** `com_acme_phonebook`  
**URL:** `http://localhost/pinoox/phonebook`  
**Полный исходный код:** [docs/source/phonebook-app/](../../source/phonebook-app/) — скопируйте в `apps/`
---

## Предварительные требования

- Установленный Pinoox
- Основы [маршрутизаторов (routers)](../basic/routers.md) и [представлений (views)](../basic/views.md)
...
## Шаг 4 — Именованные действия (Actions)
...
> **Почему два файла маршрутов?** В `actions.php` вы определяете обработчик **один раз**. В `web.php` вы лишь сопоставляете URL + HTTP-метод с этим действием (`@contact.list`). Меняйте URL, не трогая привязку контроллера.
...
Файл `theme/default/pages/list.twig`:
...
Добавьте несколько контактов и попробуйте удаление.

---

## Шаг 9 — Идеи для расширения

| Улучшение | Связанная документация |
|---------|-------------|
| Редактирование контакта | [Контроллеры (Controllers)](../basic/controllers.md) |
| Поиск | [Query Builder](../database/query-builder.md) |
| Вход в систему | [Flows / Аутентификация](../basic/flows.md) |
