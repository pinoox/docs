# Пошаговое руководство: простое блог-приложение

[← Назад к оглавлению](../README.md)

Создадим небольшой блог: **список постов**, **страница отдельного поста** со slug в URL и форма **написания поста**. Отлично подходит для изучения динамических маршрутов (routes) и нескольких Twig-страниц.

**Пакет:** `com_acme_blog`  
**URL:** `http://localhost/pinoox/blog`  
**Полный исходный код:** [docs/source/blog-app/](../../source/blog-app/) — скопируйте в `apps/`
---

## Предварительные требования

- [Маршрутизаторы (Routers)](../basic/routers.md) — параметр `{slug}`
...
> **Динамический маршрут:** `{slug}` передаётся в контроллер как `$slug`.
...
## Шаг 6 — Twig-шаблоны (встроенный CSS)
...
1. `/blog/write` — создайте пост.
2. После отправки вы попадёте на `/blog/post/your-slug`.
3. `/blog` отображает список.
...
|---------|-----|
| Список с пагинацией | [Пагинация (Pagination)](../database/pagination.md) |
| Защита `/write` | [Flows / Аутентификация](../basic/flows.md) |
...
- [Представления (Views)](../basic/views.md)
