...
Pinoox 3.x не включает **Model Factory** (в стиле Laravel) в CLI. Рекомендуемый подход для начальных и dev-данных — **Seeders** с `SeederBase` в `apps/{package}/database/seed/`.
