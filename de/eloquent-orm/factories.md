...
Pinoox 3.x enthält keine **Model Factory** (Laravel-Stil) in der CLI. Der empfohlene Ansatz für Anfangs- und Entwicklungsdaten sind **Seeder** mit `SeederBase` in `apps/{package}/database/seed/`.
