...
Ein **React-18-Task-Panel** (Todo) — API in PHP, UI in React mit Vite. Standard-React-Einstieg in Pinoox: `src/main.jsx`.

**Package:** `com_acme_react_tasks`  
**URL:** `http://localhost/pinoox/react-tasks`  
**Profile:** `spa` · **stack:** `react`  
**Vollständiger Quellcode:** [docs/source/react-spa-app/](../../source/react-spa-app/) — nach `apps/` kopieren
---

## Voraussetzungen

- Node.js 18+ und npm
- [Requests](../basic/requests.md) und [Responses](../basic/responses.md) für JSON-APIs
...
2. SPA öffnen; Aufgaben hinzufügen, abschließen und löschen.
...
| Bootstrap | `getUrl()` in `boot.js` | Gleich |
