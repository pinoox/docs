# Uygulamalı rehber: Telefon rehberi web uygulaması

[← Dizine dön](../README.md)

Twig ile basit bir **web uygulaması** oluşturun: kişileri listeleyin, form ekleyin ve kayıtları silin. Veriler MySQL'de saklanır.

**Paket:** `com_acme_phonebook`  
**URL:** `http://localhost/pinoox/phonebook`  
**Tam kaynak:** [docs/source/phonebook-app/](../../source/phonebook-app/) — `apps/` içine kopyalayın
---
...
> **Neden iki route dosyası?** `actions.php` içinde handler'ı **bir kez** tanımlarsınız. `web.php` içinde yalnızca URL + HTTP metodunu o action'a eşlersiniz (`@contact.list`). Controller bağlantısına dokunmadan URL'yi değiştirin.

---

## Adım 5 — Web route'ları
...
Dosya `theme/default/pages/list.twig`:
...
Birkaç kişi ekleyin ve silmeyi deneyin.

---

## Adım 9 — Genişletme fikirleri

| Geliştirme | İlgili dokümantasyon |
|---------|-------------|
| Kişi düzenleme | [Controllers](../basic/controllers.md) |
| Arama | [Query Builder](../database/query-builder.md) |
| Giriş | [Flows / Auth](../basic/flows.md) |
