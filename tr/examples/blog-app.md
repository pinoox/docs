# Uygulamalı rehber: Basit blog uygulaması

[← Dizine dön](../README.md)

Küçük bir blog oluşturun: **yazı listesi**, URL'de slug ile **tek yazı sayfası** ve **yazı ekleme** formu. Dinamik route'lar ve birden fazla Twig sayfası öğrenmek için uygundur.

**Paket:** `com_acme_blog`  
**URL:** `http://localhost/pinoox/blog`  
**Tam kaynak:** [docs/source/blog-app/](../../source/blog-app/) — `apps/` içine kopyalayın
---
...
> **Dinamik route:** `{slug}` parametresi controller'a `$slug` olarak iletilir.
...
1. `/blog/write` — yazı oluşturun.
2. Gönderimden sonra `/blog/post/your-slug` adresine düşersiniz.
3. `/blog` listeyi gösterir.
...
|---------|-----|
| Sayfalı liste | [Sayfalama](../database/pagination.md) |
| `/write` koruması | [Flow'lar / Auth](../basic/flows.md) |
...
- [Şablonlar (Twig)](../basic/templates.md)
