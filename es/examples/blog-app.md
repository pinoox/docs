# Tutorial: aplicación de blog simple

[← Volver al índice](../README.md)

Construye un blog pequeño: **lista de entradas**, **página de entrada individual** con slug en la URL y un formulario para **escribir entradas**. Ideal para aprender rutas dinámicas y varias páginas Twig.

**Package:** `com_acme_blog`  
**URL:** `http://localhost/pinoox/blog`  
**Código fuente completo:** [docs/source/blog-app/](../../source/blog-app/) — copiar a `apps/`
---

## Requisitos previos

- [Routers](../basic/routers.md) — parámetro `{slug}`
...
> **Ruta dinámica:** `{slug}` se pasa al controller como `$slug`.
...
## Paso 6 — Plantillas Twig (CSS inline)
...
1. `/blog/write` — crea una entrada.
2. Tras enviar el formulario, llegas a `/blog/post/your-slug`.
3. `/blog` muestra la lista.
...
| Mejora | Doc |
|---------|-----|
| Lista paginada | [Pagination](../database/pagination.md) |
