...
Pinoox 3.x no incluye **Model Factory** (estilo Laravel) en la CLI. El enfoque recomendado para datos iniciales y de desarrollo son los **Seeders** con `SeederBase` en `apps/{package}/database/seed/`.
