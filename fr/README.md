...
Documentation officielle pour les développeurs qui créent des applications sur la plateforme Pinoox (PHP 8.2+, architecture HMVC).
...
#### [Patchs (mises à jour de données)](./advanced/patches.md)
