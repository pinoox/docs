# Tutoriel pas à pas : Application de blog simple

[← Retour à l'index](../README.md)

Construisez un petit blog : **liste des articles**, **page d'article unique** avec slug dans l'URL, et un formulaire de **rédaction d'article**. Idéal pour apprendre les routes dynamiques et les pages Twig multiples.

**Package :** `com_acme_blog`  
**URL :** `http://localhost/pinoox/blog`  
**Source complète :** [docs/source/blog-app/](../../source/blog-app/) — à copier dans `apps/`
---

## Prérequis

- [Routeurs (Routers)](../basic/routers.md) — paramètre `{slug}`
...
> **Route dynamique :** `{slug}` est transmis au Controller sous la forme `$slug`.
...
1. `/blog/write` — créez un article.
2. Après l'envoi, vous arrivez sur `/blog/post/your-slug`.
3. `/blog` affiche la liste.
...
| Amélioration | Doc |
|---------|-----|
| Liste paginée | [Pagination](../database/pagination.md) |
| Protéger `/write` | [Flows / Auth](../basic/flows.md) |
